...
version(X86_64)
{
    ...
    ulong MurmurHash64(T: K[], K)(T key, immutable uint seed = 0)
    {
        ...
        switch(len & 7)
        {
            case 7: h ^= cast(ulong)(tail[6]) << 48; goto case;
            case 6: h ^= cast(ulong)(tail[5]) << 40; goto case;
            case 5: h ^= cast(ulong)(tail[4]) << 32; goto case;
            case 4: h ^= cast(ulong)(tail[3]) << 24; goto case;
            case 3: h ^= cast(ulong)(tail[2]) << 16; goto case;
            case 2: h ^= cast(ulong)(tail[1]) << 8; goto case;
            case 1: h ^= cast(ulong)(tail[0]); goto default;
            default:
                h *= m;
        }
